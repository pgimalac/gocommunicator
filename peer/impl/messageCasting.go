...
func (n *node) TypeToTransportMessage(
	msg types.Message,
) (transport.Message, error) {
	return n.conf.MessageRegistry.MarshalMessage(msg)
}

// Helper function to get a transport.Packet from a transport.Message and other
// missing header information
func (n *node) TransportMessageToPacket(
	msg transport.Message,
	source, relay, dest string,
	ttl uint,
) transport.Packet {
...
func (n *node) PacketToTransportMessage(
	pkt transport.Packet,
) transport.Message {
	return *pkt.Msg
}

// Helper function to get a transport.Packet from a types.Message and other
// missing header information
func (n *node) TypeMessageToPacket(
	msg types.Message,
	source, relay, dest string,
	ttl uint,
